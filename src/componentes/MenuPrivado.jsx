        ...
        <div>
            <nav className="navbar navbar-expand-lg navbar-light bg-light">
                <div className="container-fluid">
                    <NavLink className="navbar-brand" aria-current="page" exact to="/privado">SISACAD</NavLink>
                            ...
                            {autenticacao &&
                                <li className="nav-item dropdown">
                                    ...
                                    <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <li><NavLink className="dropdown-item" exact to="disciplinas">Disciplinas</NavLink></li>
                                        <li><NavLink className="dropdown-item" exact to="professores">Professores</NavLink></li>
                                    </ul>
                                </li>
                            }
                            <li className="nav-item dropdown">
